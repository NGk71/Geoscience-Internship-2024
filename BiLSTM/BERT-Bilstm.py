...
class BertBiLSTMForTokenClassification(nn.Module):
    def __init__(self, bert_model_name, num_labels, hidden_size=256, num_layers=1, dropout=0.1):
        super(BertBiLSTMForTokenClassification, self).__init__()
...
# Convert entities to labels function
...
model = BertBiLSTMForTokenClassification(
