...
# 输入数据
data=([
        ("第二段施工人员于2018年12月18日9:50到达井场，10:10检查好车辆并召开安全技术交底会，10:20开始施工。第二段排空用液70.00 m³，打备压65.00MPa，洗井用液140.07 m³，打备压53.70MPa，泵送桥塞用液31.52m³，打备压54.00MPa，送球用液52.52 m³，泵入前置液751.65m³,段塞加砂26.22m³,携砂液482.13m³,加砂104.14m³,最高砂比35.00%,平均砂比21.60%,顶替液120.14m³,共加纤维120Kg,施工最高压力为81.00MPa,破裂压力81.00MPa,停泵油压56.50MPa，最大排量10.88m³/min，施工用时199分钟。18:24施工结束,压裂车组于18:30整修设备,19:50离开井场。", 
    {
        "entities": [
            ("9:50", "ArrivalTime"), ("10:10", "VehicleCheckTime"), ("10:20", "StartTime"),
            ("70.00 m³", "FluidForEmptying"), ("65.00MPa", "Pressure"), ("140.07 m³", "FluidForWellFlushing"), ("53.70MPa", "Pressure"), 
            ("31.52m³", "FluidForBridgePlug"), ("54.00MPa", "Pressure"), ("52.52 m³", "FluidForBall"), ("751.65m³", "FluidForPrepad"), 
            ("26.22m³", "SandForPlug"), ("482.13m³", "FluidForProppant"), ("104.14m³", "Sand"), ("35.00%", "MaxSandRatio"), 
            ("21.60%", "AverageSandRatio"), ("120.14m³", "DisplacementFluid"), ("120Kg", "Fiber"), ("81.00MPa", "MaxPressure"), 
            ("81.00MPa", "FracturePressure"), ("56.50MPa", "PumpStopPressure"), ("10.88m³/min", "MaxFlowRate"), ("199分钟", "JobTime")
        ]
    }
    ),
    ...
    (
        "第一段施工人员于2018年12月17日14:20到达井场，15:30检查好车辆并召开安全技术交底会，15:40开始施工。第一段排空用液65.00 m³，试压90.00MPa, 尝压 1000Mpa,打备压36.60MPa，试挤用液19.47 m³，泵入预处理酸20.00m³，顶替液44.97m³，停泵反应24min后打备压54.50MPa，泵入前置液1007.39m³,段塞加砂23.98m³,携砂液415.76m³,加砂77.14m³,最高砂比35.00%,平均砂比18.55%,顶替液120.73m³,共加纤维40Kg,施工最高压力为86.00MPa,破裂压力86.00MPa,停泵油压55.30MPa，最大排量10.80m³/min，施工用时232分钟。00:42施工结束,压裂车组于00:50整修设备,1:50离开井场。",
        {
            "entities": [
                ("14:20", "ArrivalTime"), ("15:30", "VehicleCheckTime"), ("15:40", "StartTime"),
                ("65.00 m³", "FluidForEmptying"), ("90.00MPa", "TestPressure"), 
    ...
    for text, annotations in data:
        ...
        for entity in annotations["entities"]:
            ...
            if start_idx != -1:
                ...
                entities.append((start_idx, end_idx, entity[1]))
...
# 将转换后的数据保存为JSON文件
with open('train_data_spacy_format.json', 'w', encoding='utf-8') as f:
